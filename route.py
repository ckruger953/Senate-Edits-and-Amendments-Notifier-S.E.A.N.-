    ...
    try:
        ...
        if qualifying_bills:
            ...
            for row in docket_rows:
                ...
                if body == 'H':
                    dl = desc_lower
                    if 'concur' in dl and 'nonconcur' not in dl and 'reconsider' not in dl:
                        bill_map[bn]['floor_status'] = 'Concurred'
                    elif 'nonconcur' in dl and 'request' not in dl:
                        bill_map[bn]['floor_status'] = 'Nonconcurred'
                    elif 'nonconcur' in dl and 'request' in dl:
                        bill_map[bn]['floor_status'] = 'CofC Requested'
                    elif 'conference committee report' in dl or 'c of c' in dl or 'cofc' in dl:
